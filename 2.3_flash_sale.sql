-- 1. 为 shop_products 添加秒杀时效字段
ALTER TABLE shop_products ADD COLUMN IF NOT EXISTS flash_sale_end TIMESTAMPTZ;
ALTER TABLE shop_products ADD COLUMN IF NOT EXISTS flash_sale_price INT CHECK (flash_sale_price >= 0);
