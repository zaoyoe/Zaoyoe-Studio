(function (global) {
    ...
    const SUPPORT_CONFIG_SRC = 'js/support-bot-config.js?v=f5a4ba7fbfa7';
    const ADMIN_WORKBENCH_SRC = 'js/admin-workbench.js?v=f5a4ba7fbfa7';
    const CHAT_WIDGET_SRC = 'js/components/ChatWidget.js?v=f5a4ba7fbfa7&siteAssetCdn=20260510_SITE_ASSET_CDN_1';
    const CHAT_WIDGET_STYLE_SRC = 'css/chat-widget.css?v=f5a4ba7fbfa7';
    ...
    function getBootstrapScript() {
        ...
        bootstrapScript = document.currentScript
            || document.querySelector(`script[src*="js/chat-widget-loader.js?v=f5a4ba7fbfa7"]`)
