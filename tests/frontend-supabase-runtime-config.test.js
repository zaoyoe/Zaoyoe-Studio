...
test('public pages wire wallet modal through the shared bootstrap loader', () => {
    ...
    const loaderMarkers = [
        "const VERSION = '20260518_MOBILE_PAY_FAST_SYNC_1';",
        "const POINTS_SERVICE_SRC = 'js/services/PointsService.js?v=20260518_MOBILE_PAY_FAST_SYNC_1';",
        "const WALLET_MODAL_SRC = 'js/components/WalletModal.js?v=20260518_MOBILE_PAY_FAST_SYNC_1';",
...
test('shared user event tracker wires prompt, verify, and wallet conversion events', () => {
    ...
    assert.equal(verifyPageSource.includes('js/wallet-modal-loader.js?v=20260518_MOBILE_PAY_FAST_SYNC_1'), true, 'verify.html should load the latest lazy wallet modal bootstrap');
});
...
test('public light theme modal backdrops reuse the muted blue-gray glass material', () => {
    ...
    assert.equal(
        readRepoFile('js/components/WalletModal.js').includes('css/wallet.css?v=20260518_MOBILE_PAY_FAST_SYNC_1'),
        true,
