...
test('shop-related admin selects are marked for custom rendering instead of native system popups', () => {
    ...
    const markers = [
        ...
        'id="importViewSourceAutoScore" class="glass-input shop-import-source-auto-score" value="100" readonly',
        'id="importViewSourceTags" class="glass-input"',
        'id="importViewSourcePurchasedAt" class="glass-input shop-import-source-datetime-input"',
        'data-shop-action="inventory-source-datetime-open" data-date-input-id="importViewSourcePurchasedAt"',
        'id="inventorySkuSelect"\n                                        data-shop-custom-select="true"',
        'id="importModalSkuSelect"\n                                data-shop-custom-select="true"',
        'id="importModalSourceAutoScore" class="glass-input shop-import-source-auto-score" value="100" readonly',
        'id="importModalSourceTags" class="glass-input"',
        'id="importModalSourcePurchasedAt" class="glass-input shop-import-source-datetime-input"',
        'data-shop-action="inventory-source-datetime-open" data-date-input-id="importModalSourcePurchasedAt"',
...
test('shop admin runtime exposes custom select enhancement and homepage sync hooks', () => {
    ...
    const runtimeMarkers = [
        ...
        'data-shop-custom-select-note',
        'data-shop-custom-select-tone',
        'shop-custom-select__option-swatch',
        'shop-custom-select__option-note',
    ...
    const styleMarkers = [
        ...
        '.shop-custom-select__option-main',
        '.shop-custom-select__option-swatch',
        '.shop-custom-select__option-note',
        '.shop-custom-select__option[data-shop-custom-select-tone="alias"]',
