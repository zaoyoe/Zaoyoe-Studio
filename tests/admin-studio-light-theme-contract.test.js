...
test('admin studio has a light-theme bridge for legacy dark admin surfaces', () => {
    ...
    assert.equal(
        chatStylesSource.includes('20260424_ADMIN_CHAT_LIGHT_THEME_FROSTED_CONTEXT_FLAT_ALERTS_1'),
        true,
    ...
    assert.equal(
        readRepoFile('admin-studio.html').includes('css/admin-chat.css?v=20260424_ADMIN_CHAT_LIGHT_THEME_FROSTED_CONTEXT_FLAT_ALERTS_1'),
        true,
