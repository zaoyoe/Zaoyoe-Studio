...
test('homepage ships a static first-paint hero while runtime data hydrates', () => {
    ...
    assert.ok(
        indexSource.indexOf('./js/nav-auth-fast-paint.js?v=20260501_NAV_AUTH_FAST_PAINT_1') < indexSource.indexOf('./supabase-auth-functions.js?v=20260509_GOOGLE_PROMPT_FIRST_1'),
