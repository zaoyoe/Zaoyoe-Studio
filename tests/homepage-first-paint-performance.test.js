...
test('homepage ships a static first-paint hero while runtime data hydrates', () => {
    ...
    assert.ok(
        indexSource.indexOf('./css/home-prompts-skeleton-critical.css?v=20260530_HOME_PROMPTS_SKELETON_GRID_1') < indexSource.indexOf('./css/framer_home.css?v=20260620_HOME_SHOP_MOBILE_HEADER_CENTER_1'),
    ...
    assert.equal(
        indexSource.includes('./css/framer_home.css?v=20260620_HOME_SHOP_MOBILE_HEADER_CENTER_1'),
        true,
