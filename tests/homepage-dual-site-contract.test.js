...
test('site layout admin editor and runtime wire footer contacts without stale cache lock-in', () => {
    ...
    assert.match(framerHomeCssSource, /\.footer-support-links \.site-layout-support-link\.site-layout-support-link--inline-feedback-active,[\s\S]*?\.footer-bottom-support-links \.site-layout-support-link\.site-layout-support-link--inline-feedback-active \{[\s\S]*?min-width:\s*56px;[\s\S]*?min-height:\s*26px;[\s\S]*?padding:\s*0 9px;[\s\S]*?border-radius:\s*999px;[\s\S]*?transition:\s*none;[\s\S]*?pointer-events:\s*none;/);
    ...
    assert.match(framerHomeCssSource, /html\[data-theme="light"\] \.footer-support-links \.site-layout-support-link--inline-feedback-active:hover,[\s\S]*?\.footer-bottom-support-links \.site-layout-support-link--inline-feedback-active:active \{[\s\S]*?background:\s*rgba\(22, 163, 74, 0\.1\) !important;[\s\S]*?box-shadow:\s*none;[\s\S]*?transform:\s*none !important;/);
    assert.match(framerHomeCssSource, /\.footer-support-links \.site-layout-support-link\.site-layout-support-link--inline-feedback-active \.site-support-icon,[\s\S]*?\.footer-bottom-support-links \.site-layout-support-link\.site-layout-support-link--inline-feedback-active \.site-support-icon \{[\s\S]*?display:\s*none;/);
