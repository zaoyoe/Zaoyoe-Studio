...
test('keyboard dock styles and cache keys are wired for affected public/admin surfaces', () => {
    ...
    assert.match(shopHtml, /shop-client\.js\?v=20260513_SHOP_MOBILE_TAP_FALLBACK_1/);
    ...
    assert.match(chatWidgetLoader, /const VERSION = '20260516_HOME_AUTH_CHAT_CACHE_BUST_1';/);
    ...
    assert.match(walletLoader, /const VERSION = '20260518_MOBILE_ALIPAY_DIRECT_APP_1';/);
});
