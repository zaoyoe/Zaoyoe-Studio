...
test('heavy page runtimes and engagement chrome load without blocking first paint', () => {
    const expectations = {
        'index.html': [
            'js/chat-widget-loader.js?v=20260910_CHAT_WIDGET_NEWAPI_BADGE_1&siteAssetCdn=20260510_SITE_ASSET_CDN_1&componentSelectGuard=20260530_PUBLIC_COMPONENT_SELECT_GUARD_1'
        ],
        'shop.html': [
            'js/chat-widget-loader.js?v=20260910_CHAT_WIDGET_NEWAPI_BADGE_1&siteAssetCdn=20260510_SITE_ASSET_CDN_1&componentSelectGuard=20260530_PUBLIC_COMPONENT_SELECT_GUARD_1'
        ],
...
test('subpage chat and notification styles are deferred until their loaders need them', () => {
    ['verify.html', 'prompts.html', 'guestbook.html'].forEach((relativePath) => {
        ...
        assert.match(
            source,
            /<link rel="stylesheet" href="css\/chat-widget\.css\?v=20260910_CHAT_WIDGET_NEWAPI_BADGE_1&componentSelectGuard=20260530_PUBLIC_COMPONENT_SELECT_GUARD_1" media="print" data-deferred-style="1" data-deferred-style-mode="manual" data-deferred-style-group="public-chat">/,
