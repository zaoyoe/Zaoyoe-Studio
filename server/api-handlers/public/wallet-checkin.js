...
function loadDefaultCheckinDiscountLinkageHelper() {
    const {
...
function createWalletCheckinHandler({
    admin,
    site,
    loadDiscountLinkageHelper = loadDefaultCheckinDiscountLinkageHelper
}) {
    ...
    function getCheckinDiscountLinkageHelper() {
        ...
        try {
            maybeIssueCheckinDiscountAssets = loadDiscountLinkageHelper();
        } catch (error) {
    ...
    return async function walletCheckinHandler(req, res) {
        const {
            parseJsonBody,
