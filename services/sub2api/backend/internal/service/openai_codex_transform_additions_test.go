...
func TestDefaultCodexSynthInstructionsModelAware(t *testing.T) {
	...
	require.True(t, strings.Contains(defaultCodexSynthInstructions("gpt-5.4"), "You are GPT-5.4 running in the Codex CLI"))
	require.True(t, strings.Contains(defaultCodexSynthInstructions("gpt-5"), "You are GPT-5 running in the Codex CLI"))
	require.False(t, strings.Contains(defaultCodexSynthInstructions("gpt-5.5"), "GPT-5.1 running in the Codex CLI"))
	require.False(t, strings.Contains(defaultCodexSynthInstructions("gpt-5.4"), "GPT-5.1 running in the Codex CLI"))
