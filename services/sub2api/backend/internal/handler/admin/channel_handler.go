...
type channelModelPricingRequest struct {
	...
	UpstreamCostMultiplier *float64                 `json:"upstream_cost_multiplier" binding:"omitempty,min=0"`
	UpstreamPricingGroup   string                   `json:"upstream_pricing_group" binding:"omitempty,max=120"`
	UpstreamPricingVersion string                   `json:"upstream_pricing_version" binding:"omitempty,max=120"`
...
type channelModelPricingResponse struct {
	...
	UpstreamPricingGroup   string                    `json:"upstream_pricing_group"`
...
func pricingToResponse(p *service.ChannelModelPricing) channelModelPricingResponse {
	...
	return channelModelPricingResponse{
		...
		UpstreamCostMultiplier: p.UpstreamCostMultiplier,
		UpstreamPricingGroup:   p.UpstreamPricingGroup,
		UpstreamPricingVersion: p.UpstreamPricingVersion,
		Intervals:              intervals,
	}
}
...
func pricingRequestToService(reqs []channelModelPricingRequest) []service.ChannelModelPricing {
	...
	for _, r := range reqs {
		...
		result = append(result, service.ChannelModelPricing{
			...
			UpstreamCostMultiplier: r.UpstreamCostMultiplier,
			UpstreamPricingGroup:   r.UpstreamPricingGroup,
			UpstreamPricingVersion: r.UpstreamPricingVersion,
			Intervals:              intervals,
		})
	}
	return result
