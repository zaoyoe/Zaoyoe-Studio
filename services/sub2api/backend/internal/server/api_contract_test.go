				...
				"data": {
					...
					"password_reset_enabled": false,
						...
						"login_agreement_documents": [
							...
							{"id": "acceptable-use", "title": "可接受使用政策", "content_md": ""},
							{"id": "refund", "title": "退款和暂停政策", "content_md": ""},
							{"id": "restricted-regions", "title": "受限地区说明", "content_md": ""}
						],
...
func newContractDeps(t *testing.T) *contractDeps {
	...
	v1Keys.GET("/keys/regional-restriction", apiKeyHandler.GetRegionalRestrictionStatus)
