    ...
    channels: {
      ...
      form: {
        ...
        ruleModelPricing: 'Model Pricing',
         ...
         upstreamCostMultiplier: 'Upstream cost ratio',
         upstreamPricingVersion: 'Upstream pricing version',
         upstreamPricingMetadataHint: 'Prices use the official/upstream reference basis. This ratio is used only for account cost statistics and is not added to customer charges.',
