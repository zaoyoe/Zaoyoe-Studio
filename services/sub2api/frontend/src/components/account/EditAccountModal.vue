...
const loadWebSearchEmulationConfig = adminAPI.settings?.getWebSearchEmulationConfig
if (typeof loadWebSearchEmulationConfig === 'function') {
  loadWebSearchEmulationConfig().then(cfg => {
