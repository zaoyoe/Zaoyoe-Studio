<template>
  <BaseDialog
    ...
    @close="$emit('close')"
  >
    <form v-if="user" id="edit-user-form" @submit.prevent="handleUpdateUser" class="space-y-3 sm:space-y-5">
      <div>
      ...
      <div>
        ...
        <div class="flex gap-2">
          ...
          <button type="button" @click="generatePassword" class="btn btn-secondary shrink-0 px-3">
