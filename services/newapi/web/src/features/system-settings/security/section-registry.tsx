...
import { RegionalRestrictionSection } from './regional-restriction-section'
...
const SECURITY_SECTIONS = [
  ...
  },
  {
    ...
    titleKey: 'Regional Restriction',
    build: (settings: SecuritySettings) => (
      <RegionalRestrictionSection
        defaultValues={{
          ...
          'regional_restriction.oauth_signup_enabled':
            settings['regional_restriction.oauth_signup_enabled'],
          'regional_restriction.api_key_page_confirmation_enabled':
            settings['regional_restriction.api_key_page_confirmation_enabled'],
          'regional_restriction.api_key_create_enabled':
            settings['regional_restriction.api_key_create_enabled'],
          'regional_restriction.blocked_country_codes':
            settings['regional_restriction.blocked_country_codes'],
          'regional_restriction.unknown_region_policy':
            settings['regional_restriction.unknown_region_policy'],
          'regional_restriction.confirmation_revision':
            settings['regional_restriction.confirmation_revision'],
          'regional_restriction.confirmation_frequency':
            settings['regional_restriction.confirmation_frequency'],
          'regional_restriction.confirmation_interval_hours':
            settings['regional_restriction.confirmation_interval_hours'],
        }}
      />
    ),
  },
