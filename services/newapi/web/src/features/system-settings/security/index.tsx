...
const defaultSecuritySettings: SecuritySettings = {
  ...
  'regional_restriction.api_key_create_enabled': false,
  'regional_restriction.blocked_country_codes': ['CN'],
  'regional_restriction.unknown_region_policy': 'allow',
  'regional_restriction.confirmation_revision': '2026-06-17',
  'regional_restriction.confirmation_frequency': 'once_per_revision',
