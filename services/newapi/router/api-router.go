...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/acceptable-use", controller.GetAcceptableUse)
		apiRouter.GET("/refund-policy", controller.GetRefundPolicy)
		apiRouter.GET("/restricted-regions", controller.GetRestrictedRegions)
		...
		apiRouter.GET("/channel-status", middleware.HeaderNavModuleAuth("status"), controller.GetChannelStatus)
		apiRouter.GET("/verification", middleware.TryUserAuth(), middleware.EmailVerificationRateLimit(), middleware.TurnstileCheck(), controller.SendEmailVerification)
		...
		tokenRoute.Use(middleware.UserAuth())
		{
			...
			tokenRoute.GET("/regional-restriction", controller.GetRegionalRestrictionStatus)
