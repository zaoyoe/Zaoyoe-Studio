...
const PROFILE_MODAL_BOOTSTRAP_SRC = 'js/profile-modal-loader.js?v=994dcbe92774';
...
function prefetchGooglePopupCloseShell() {
    ...
    const urls = [
        ...
        { href: new URL(`/js/auth-popup-close-page.js?v=994dcbe92774`, window.location.origin).toString(), as: 'script' },
        { href: new URL(`/css/auth-popup-close.css?v=994dcbe92774`, window.location.origin).toString(), as: 'style' }
    ];
