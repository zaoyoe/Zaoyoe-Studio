...
const PROFILE_MODAL_BOOTSTRAP_SRC = 'js/profile-modal-loader.js?v=dcb98464f0c8';
...
function prefetchGooglePopupCloseShell() {
    ...
    const urls = [
        ...
        { href: new URL(`/js/auth-popup-close-page.js?v=dcb98464f0c8`, window.location.origin).toString(), as: 'script' },
        { href: new URL(`/css/auth-popup-close.css?v=dcb98464f0c8`, window.location.origin).toString(), as: 'style' }
    ];
