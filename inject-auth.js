(function () {
    ...
    const AUTH_SHEET_CSS_HREF = './css/auth-sheet.css?v=87e2e3d98e61&componentSelectGuard=20260530_PUBLIC_COMPONENT_SELECT_GUARD_1&inputPaste=20260609_INPUT_PASTE_1&authStagger=20260619_AUTH_SHEET_TOP_DOWN_STAGGER_1';
    const SUPPORT_SCRIPT_SRC = './script.js?v=87e2e3d98e61';
    ...
    function buildDropdownHTML(profile) {
        ...
        return `
            <div id="userDropdown" class="avatar-dropdown auth-dropdown-layer ${isLoggedIn ? 'is-authenticated' : 'is-guest'}" data-auth-state="${isLoggedIn ? 'authenticated' : 'guest'}" aria-hidden="true">
