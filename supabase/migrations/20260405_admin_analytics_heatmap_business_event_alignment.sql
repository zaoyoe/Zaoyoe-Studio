-- Promote analytics activity heatmap to real business events first,
-- while keeping login history as an automatic fallback when no business
-- events exist in the selected window.
