-- P2 refund RPC re-hardening.
-- Re-applies the current site-aware, service-role-only refund implementation so
-- environments that previously ran a legacy enhanced refund script cannot keep
-- the browser-callable RPC or single-site refund behavior.
