-- ============================================
-- Harden Shop Discount Validation & Site Isolation
-- - remove public discount code reads
-- - restore site-aware shop purchase accounting
-- - add authenticated discount preview RPC for the shop UI
-- ============================================
