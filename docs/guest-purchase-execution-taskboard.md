...
- 后续执行与百分比以任务 2.0 为准；2.0 当前总进度 **48%**（A/B/C/F/H 完成；D in_progress，D3-01/D3-13/D3-17/D3-04/D3-03/D3-02/D3-05/D3-06/D3-07/D3-20/D3-11/D3-12/D3-10/D3-19/D3-18/D3-14/D3-15/D3-09 PASS，D3-08 BLOCKED+ZPay currency is site-derived，已补 price_points_intl=144，INTL 成功支付仍等人自建真付，D3-16 未开始）。本文件冻结进度仍为 **82%**，不回写 2.0 百分比到下方 1.0 checkbox。
- 当前阶段指针：`任务 2.0 / D 真实支付矩阵 in_progress；已补商品级+SKU 级 price_points_intl=144；shop 前端 intl 过滤已可放行；等人硬刷新 ?site=intl 后自建 USDT-BEP20；D3-16 未开始`
